...
type UpdatedHook interface {
	Updated(ctx context.Context, result interface{}) error
}
...
type DeletedHook interface {
	Deleted(ctx context.Context, result interface{}) error
}
...
func callToAfterUpdateHooks(ctx context.Context, updateResult interface{}, model Model) error {
...
func callToAfterDeleteHooks(ctx context.Context, deleteResult interface{}, model Model) error {
